...
//     return (
//         <div
//             className="bg-orange-100 border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
//             onClick={onSelect}
//         >
//             <div
...
const SummaryCard = ({
    ...
    return (
        <div
            className="bg-orange-100 border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group transition-all duration-200"
            onClick={onSelect}
        >
            {/* Card Header */}
            <div
                className="rounded-lg p-4 relative flex flex-col sm:flex-row sm:items-start gap-4"
                style={{
                    background: colors.bgColor,
                }}
            >
                ...
                <div className="flex-grow">
                    <div className="flex justify-between items-start">
                        <div className="space-y-1">
                            <h2 className="text-base sm:text-lg font-medium">{role}</h2>
                            <p className="text-xs sm:text-sm text-gray-900 line-clamp-1">
                                {topicsToFocus}
                            </p>
                        </div>
                    </div>
