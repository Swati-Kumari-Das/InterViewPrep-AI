  ...
  <div className="container mx-auto px-4 pt-6 relative z-10">
    ...
    <div className="flex flex-col md:flex-row items-center">
      <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
        <div className="inline-flex items-center gap-2 text-[13px] text-amber-600 font-semibold bg-amber-100 px-3 py-1 rounded-full border border-amber-300 mb-2">
      ...
      <div className="w-full min-h-full relative z-10 ">
        <div>
          <section className="flex items-center justify-center -mt-96">
            <img 
            src={HERO_IMG}
            alt="Hero Image"
        ...
        <div className="container mx-auto px-4 pt-10 pb-20">
          <section className="mt-5">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-col-3 gap-8 w-full">
